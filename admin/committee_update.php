        ...
        <div class="right_col">
          ...
          <div class="panel panel-default">
            <div class="panel-body">
                ...
                ?>
                <form class="form-horizontal" action="update.php?action=committee" method="post">
                <input type="text" name="transfer" value="<?=$_SESSION['transfer']?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-9 control-label" style="text-align: left;">
                      <?php
                          ...
                          $itemCount1 = isset($_SESSION['cart1']) ? count($_SESSION['cart1']) : 0;
                          if (isset($_SESSION['cart1']) and $itemCount1 > 0)
                          {
                              $itemIds1 = "";
                              foreach ($_SESSION['cart1'] as $itemId1)
                              {
                                  $itemIds1 = $itemIds1 . $itemId1 . ",";
                                  $itemId1;
                              }
                              $inputItems1 = rtrim($itemIds1, ",");
                              
                              $q1 = $db->prepare("SELECT * FROM member NATURAL JOIN course WHERE member_id in ({$inputItems1}) ");
                              $q1->execute();
                          ...
                          <tbody>
                              ...
                              while ($r1 = $q1->fetch(PDO::FETCH_ASSOC)) {
                                  ...
                                  $key1 = array_search($r1['member_id'], $_SESSION['cart1']);
                                  ...
                                  <tr>
                                      ...
                                      <td class="text-center">
                                          <a class="btn btn-danger" href="admin_remove_cart1.php?itemId1=<?php echo $r1['member_id']; ?>" role="button">
