...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 25, 2017 at 05:51 AM
...
(1, 0, 0, 'admin', '', '', 'admin@admin', '', 0, '21232f297a57a5a743894a0e4a801fc3', 0),
(2, 1, 1, 'นายมูฮามะฟาอิส', 'จูเปาะ', '0908673624', 'faiz@gmail.com', 'Narathiwat', 1, '698d51a19d8a121ce581499d7b701668', 1),
(3, 1, 1, 'นายรอฮีมี', 'ดือราแม', '0807019071', 'mee@gmail.com', 'Pattani', 2, '698d51a19d8a121ce581499d7b701668', 1),
(4, 1, 1, 'นายภาริ', 'สาแม', '0921212321', 'phari@gmail.com', 'Yala', 2, '698d51a19d8a121ce581499d7b701668', 1);
...
(1, 2, '4111244', 1, 'วพ.210', 3, 2),
(2, 2, '4111248', 1, 'CSF11103', 2, 2),
(3, 2, '4111248', 1, 'วพ.201', 3, 0),
(4, 2, '4111248', 1, 'CSF11103', 2, 0),
(5, 2, '4111244', 1, 'วพ.210', 3, 0);
...
--
ALTER TABLE `transfer_detail`
  MODIFY `td_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=11;
--
...
--
ALTER TABLE `tb_answer`
  ADD CONSTRAINT `tb_answer_ibfk_1` FOREIGN KEY (`id_person`) REFERENCES `tb_person` (`id_person`),
  ADD CONSTRAINT `tb_answer_ibfk_2` FOREIGN KEY (`id_question`) REFERENCES `tb_question` (`id_question`);
